...
mountpoint -q /mnt/volume_fra1_02 || mount -o discard,defaults,noatime /dev/disk/by-id/scsi-0DO_Volume_volume-fra1-02 /mnt/volume_fra1_02
grep -q "volume_fra1_02" /etc/fstab || echo '/dev/disk/by-id/scsi-0DO_Volume_volume-fra1-02 /mnt/volume_fra1_02 ext4 defaults,nofail,discard 0 0' | tee -a /etc/fstab
